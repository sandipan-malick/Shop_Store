    ...
    <footer className="py-6 mt-10 text-gray-200 bg-gray-900">
      <div className="container grid gap-6 px-6 mx-auto text-sm md:grid-cols-3">
        ...
        <div>
          ...
          <p className="mb-1">
            Name: <span className="font-medium">Sandipan Malick</span>
          </p>
          <p>
            Contact: <span className="font-medium">7364853753</span>
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-1 list-disc list-inside">
            <li>
              First add the product in <span className="font-medium text-green-400">Item</span> section.
            </li>
            <li>Then search the product by name.</li>
            <li>
              You can update the <span className="font-medium">price</span>,{" "}
              <span className="font-medium">quantity</span> and all items.
            </li>
        ...
        <div>
          ...
          <ul className="space-y-1">
            <li>
              <span className="font-medium text-red-400">0</span> → No product quantity available
            </li>
            <li>
              <span className="font-medium text-green-400">Green</span> → Product available with stock
            </li>
          </ul>
        </div>
      </div>
